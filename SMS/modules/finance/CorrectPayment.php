...
while($row=mysqli_fetch_assoc($result)){
 ...
 <div class="form-title">Receipt Number</div>
   ...
   <input type="number" name="txtAmount" id="txtAmount" class="form-field"  value="<?php echo $amnt?>" readonly="readonly" min="0" />
...
<div class="form-title">Correct Amount</div>
 <input type="number" maxlength="6" name="txtCorrect_Amount" id="txtCorrect_Amount"  required class="form-field" />
